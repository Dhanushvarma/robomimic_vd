    ...
    try:
        for step_i in range(0,horizon): #TODO: Check the indexing logic
            ...
            if step_i % interval == 0:
                ...
                subgoal_index_from_gaze = gaze_subgoal_index(pp_sgs=pp_sgs, gaze_input=gaze_input) # CLOSEST SUBGOAL TO GAZE IN PIXEL SPACE
               
                choosen_subgoal = choose_subgoal(sg_proposals, subgoal_index_from_gaze) # USING INDEX TO CHOOSE THE RESPECTIVE SUBGOAL
